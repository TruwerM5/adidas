globalThis._importMeta_={url:import.meta.url,env:process.env};import 'file:///home/kali/Documents/projects/Adidas/node_modules/node-fetch-native/dist/polyfill.mjs';
import { Server } from 'node:http';
import { tmpdir } from 'node:os';
import { join } from 'node:path';
import { mkdirSync } from 'node:fs';
import { parentPort, threadId } from 'node:worker_threads';
import { defineEventHandler, handleCacheHeaders, createEvent, eventHandler, setHeaders, sendRedirect, proxyRequest, setResponseStatus, getRequestHeader, setResponseHeader, getRequestHeaders, createApp, createRouter as createRouter$1, toNodeListener, fetchWithEvent, lazyEventHandler, readBody, setCookie, getQuery as getQuery$1, createError } from 'file:///home/kali/Documents/projects/Adidas/node_modules/h3/dist/index.mjs';
import bcrypt from 'file:///home/kali/Documents/projects/Adidas/node_modules/bcrypt/bcrypt.js';
import mongoose from 'file:///home/kali/Documents/projects/Adidas/node_modules/mongoose/index.js';
import jwt from 'file:///home/kali/Documents/projects/Adidas/node_modules/jsonwebtoken/index.js';
import { createRenderer } from 'file:///home/kali/Documents/projects/Adidas/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { stringify, uneval } from 'file:///home/kali/Documents/projects/Adidas/node_modules/devalue/index.js';
import { renderToString } from 'file:///home/kali/Documents/projects/Adidas/node_modules/vue/server-renderer/index.mjs';
import { createFetch as createFetch$1, Headers } from 'file:///home/kali/Documents/projects/Adidas/node_modules/ofetch/dist/node.mjs';
import destr from 'file:///home/kali/Documents/projects/Adidas/node_modules/destr/dist/index.mjs';
import { createCall, createFetch } from 'file:///home/kali/Documents/projects/Adidas/node_modules/unenv/runtime/fetch/index.mjs';
import { createHooks } from 'file:///home/kali/Documents/projects/Adidas/node_modules/hookable/dist/index.mjs';
import { snakeCase } from 'file:///home/kali/Documents/projects/Adidas/node_modules/scule/dist/index.mjs';
import { klona } from 'file:///home/kali/Documents/projects/Adidas/node_modules/klona/dist/index.mjs';
import defu, { defuFn } from 'file:///home/kali/Documents/projects/Adidas/node_modules/defu/dist/defu.mjs';
import { hash } from 'file:///home/kali/Documents/projects/Adidas/node_modules/ohash/dist/index.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery } from 'file:///home/kali/Documents/projects/Adidas/node_modules/ufo/dist/index.mjs';
import { createStorage, prefixStorage } from 'file:///home/kali/Documents/projects/Adidas/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///home/kali/Documents/projects/Adidas/node_modules/unstorage/drivers/fs.mjs';
import { toRouteMatcher, createRouter } from 'file:///home/kali/Documents/projects/Adidas/node_modules/radix3/dist/index.mjs';
...
const serverAssets = [{"baseName":"server","dir":"/home/kali/Documents/projects/Adidas/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/home/kali/Documents/projects/Adidas","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/home/kali/Documents/projects/Adidas/server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/home/kali/Documents/projects/Adidas/.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/home/kali/Documents/projects/Adidas/.nuxt/cache","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _cdsPH99qO8 = defineEventHandler(async () => {
  try {
    await mongoose.connect(config$1.mongodbUri);
...
const _lazy_oA9V9R = () => Promise.resolve().then(function () { return cart_get$1; });
const _lazy_VlzaS3 = () => Promise.resolve().then(function () { return cart_post$1; });
const _lazy_1WzYKQ = () => Promise.resolve().then(function () { return _code__get$3; });
const _lazy_3GFjBn = () => Promise.resolve().then(function () { return login_post$1; });
const _lazy_bYUslG = () => Promise.resolve().then(function () { return products_get$1; });
const _lazy_xzieII = () => Promise.resolve().then(function () { return _code__get$1; });
const _lazy_zuIuOy = () => Promise.resolve().then(function () { return codeMany_get$1; });
const _lazy_YtoC1t = () => Promise.resolve().then(function () { return _gender__get$1; });
const _lazy_bOiAV0 = () => Promise.resolve().then(function () { return setQuantity$1; });
const _lazy_HDrblD = () => Promise.resolve().then(function () { return signup_post$1; });
const _lazy_NWjSDb = () => Promise.resolve().then(function () { return user_get$1; });
const _lazy_QLa7Sr = () => Promise.resolve().then(function () { return users_post$1; });
const _lazy_EM1oD3 = () => Promise.resolve().then(function () { return watched_post$1; });
const _lazy_sQoAsy = () => Promise.resolve().then(function () { return wishlist_post$1; });
const _lazy_Ufb4b2 = () => Promise.resolve().then(function () { return renderer$1; });
...
const cart_get = defineEventHandler(async (evt) => {
  ...
  const requestToCart = await Cart$1.findOne({ token });
...
const cart_post = defineEventHandler(async (evt) => {
  ...
  await Cart$1.findOne({
    token: body.token,
    "products.productCode": body.productCode,
    "products.size": body.size
  });
  const Product = await product$1.findOne({ code: body.productCode }, `
    name color gallery price code discount`);
  const oldProduct = await Cart$1.findOne({
    token: body.token,
    "products.productCode": body.productCode,
    "products.size": body.size
  });
...
const _code__get$2 = defineEventHandler(async (evt) => {
  const params = evt.context.params.code.split(",");
  return await product$1.find({ code: { $in: params } });
});

const _code__get$3 = /*#__PURE__*/Object.freeze({
  __proto__: null,
  default: _code__get$2
});
...
const products_get = defineEventHandler(async () => {
  const products = await product$1.find();
  return products;
});
...
const _code__get = defineEventHandler(async (evt) => {
  return await product$1.findOne({ code: evt.context.params.code });
});

const _code__get$1 = /*#__PURE__*/Object.freeze({
  __proto__: null,
  default: _code__get
});
...
const codeMany_get = defineEventHandler(async (evt) => {
  ...
  codes = codes.split(", ");
  const response = await product$1.find({ code: { $in: codes } });
  return response;
});

const codeMany_get$1 = /*#__PURE__*/Object.freeze({
  __proto__: null,
  default: codeMany_get
});

const _gender__get = defineEventHandler(async (evt) => {
  const gender = evt.context.params.gender;
  return await product$1.find({ sex: gender });
});

const _gender__get$1 = /*#__PURE__*/Object.freeze({
  __proto__: null,
  default: _gender__get
});
...
const setQuantity$1 = /*#__PURE__*/Object.freeze({
  __proto__: null,
  default: setQuantity
});
...
const signup_post = defineEventHandler(async (evt) => {
  try {
    ...
    const user = await User$1.create({ email, password: hash, token });
    setCookie(evt, "token", token, { maxAge: 7200 });
    return { user };
  } catch (e) {
...
const user_get = defineEventHandler(async (evt) => {
  ...
  const user = await User$1.findOne({ token });
  const cart = await Cart$1.findOne({ token });
  const context = {
    email: user.email,
    orders: user.orders,
...
const watched_post = defineEventHandler(async (evt) => {
  const body = await readBody(evt);
  await User$1.updateOne({ token: body.token }, { $push: { watchedList: body.product } });
  return true;
});

const watched_post$1 = /*#__PURE__*/Object.freeze({
  __proto__: null,
  default: watched_post
});

const wishlist_post = defineEventHandler(async (event) => {
  const body = await readBody(event);
  if (body.action === "push") {
    await User$1.updateOne({ token: body.token }, { $push: { wishlist: body.product } });
    return { message: "pushed" };
  } else if (body.action === "pull") {
    await User$1.updateOne({ token: body.token }, { $pull: { wishlist: body.product } });
    return { message: "pulled" };
  }
});

const wishlist_post$1 = /*#__PURE__*/Object.freeze({
  __proto__: null,
  default: wishlist_post
});
...
const getClientManifest = () => import('/home/kali/Documents/projects/Adidas/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getStaticRenderedHead = () => Promise.resolve().then(function () { return _virtual__headStatic$1; }).then((r) => r.default || r);
const getServerEntry = () => import('/home/kali/Documents/projects/Adidas/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
...
const _virtual__headStatic = {"headTags":"<meta charset=\"utf-8\">\n<title>Adidas</title>\n<meta name=\"viewport\" content=\"width=device-width, initial-scale=1\">\n<meta name=\"lang\" content=\"en\">","bodyTags":"","bodyTagsOpen":"","htmlAttrs":"","bodyAttrs":""};
